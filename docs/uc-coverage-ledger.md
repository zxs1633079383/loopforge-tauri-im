...
> - **⬜ pending = 9**：1.2 / 1.5 / 1.8 / 4.2 / 5.4 / 6.3 / 9.x / 10.1 / 10.2（注：UC-6.4 已转 ✅·暖栈实跑双 endpoint 四面绿·issue #27；UC-2.2 已转 ✅·原「① blocked on helix wire-bug」判断有误·round6@bbbf809 已含 acl is_query 放行 fix·实跑 ①②③ 全绿；UC-4.1 / UC-5.1 / UC-5.2 / UC-1.9 / UC-1.10 / UC-3.3 / UC-1.4 / UC-1.7 / UC-2.4 / UC-2.1 / UC-2.3 已转 ✅；UC-3.1 / UC-3.2 转 🟡 read-echo gap）。
