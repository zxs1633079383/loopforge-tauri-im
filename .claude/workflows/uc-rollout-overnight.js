...
- **确认即修+验证**：红→三段日志(${RUNBOOK} §6.1)定位哪一端→loopforge/helix/reducer/装饰器/环境缺陷就**改+复跑验证**(helix 在 /System/Volumes/Data/workspace/rust/helix 改+commit·不 merge 主线)。cses-im-server 默认对。
