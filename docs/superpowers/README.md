...
| `specs/2026-07-06-loopforge-global-trace-design.md` | global trace | `docs/trace/otel-trace-gate.md` 与 `.loop-engine/runs/*/next.md` |
| `specs/2026-07-07-trace-scope-guard-spec.md` | trace scope guard | `.loop-engine/runs/trace-scope-guard-20260707/next.md` |
